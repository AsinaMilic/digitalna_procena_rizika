                                            ...
                                            <div className="mt-6">
                                                ...
                                                <div className="space-y-2">
                                                    {pravnoLice.procene.map((procena) => (
                                                        <div key={procena.id} className={`flex items-center justify-between p-3 rounded-lg ${
                                                            procena.status === 'u_toku' ? 'bg-orange-50 border border-orange-200' : 'bg-gray-50'
                                                        }`}>
                                                            <div className="flex items-center space-x-3">
                                                                <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                                                                    procena.status === 'u_toku' ? 'bg-orange-100' : 'bg-blue-100'
                                                                }`}>
                                                                    <svg className={`w-4 h-4 ${
                                                                        procena.status === 'u_toku' ? 'text-orange-600' : 'text-blue-600'
